...
from gruModels.LSTM import LSTMCell
...
train_data =train_data[0:200000]
train_label=train_label[0:200000]
validation_data = validation_data[0:86746]
validation_label =validation_label[0:86746]
test_data = test_data[0:86746]
test_label = test_label[0:86746]
...
cell = LSTMCell(input_size,state_size)
